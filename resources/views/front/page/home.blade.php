            ...
            <div class="offer">
                <div class="offer__left">
                    ...
                    <div class="offer__text">
                        <ul class="txt">
                            <li>Первый и единственный сервис в мире!</li>
                            <li>Кэшбек реальными деньгами на вашу карту</li>
                        </ul>
                    </div>
            ...
            <div class="taking">
                <div class="takingCard">
                    ...
                    <ul class="takingCard__list">
                        ...
                        <li>
                            Нет затрат на создание интернет-магазина
                        </li>
                        <li>
            ...
            <div class="offer offer-margin">
                <div class="offer__left offer__left-width">
                    ...
                    <div class="offer__text txt">
                        <p>
                            Совершая любые покупки в G-Market Вы получаете полную стоимость заказа на свой персональный счет и можете потратить эти деньги на новую
                            покупку или без проблем вывести на карту. Как такое возможно?
                        </p>
                        <p>
                            На самом деле, все очень просто! Заказывая товар через G-Market Вы тем самым помогаете компании зарабатывать и
                            увеличивать оборот. Чем чаще Вы это делаете — тем быстрее оборачиваемость капитала. В качестве благодарности за
                            это компания &laquo;делится&raquo; частью заработанной прибыли. Чтобы иметь возможность выплатить 100% стоимости покупки,
                            деньги, уплаченные за товар должны обернуться много раз — поэтому выплата кэшбэка растянута во времени.
                        </p>
                    </div>
                    <a href="{{ route('front.about') }}" class="offer__btn offer__btn-center btn">
                        <span>Подробнее</span>
                        <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="26px" height="9px">
