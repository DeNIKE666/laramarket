        ...
        <div class="wrapper">
            ...
            <div class="cartBlock cartData">
                ...
                <div class="cartAddress__row cartData__row">
                    <div class="cartData__inp">
                        ...
                        {{ Form::text('name', Auth::user()->name, ['placeholder' => 'Ф.И.О.', 'class' => 'cartAddress__inp', 'required' => 'required']) }}
                    </div>
                    <div class="cartData__inp">
                        <div class="cartAddress__icon">
                            <svg
                        ...
                        {{ Form::text('phones', Auth::user()->phone, ['placeholder' => 'Телефон', 'class' => 'cartAddress__inp', 'required' => 'required']) }}
                    </div>
                    <div class="cartData__inp">
                        <div class="cartAddress__icon">
                            <svg
                        ...
                        {{ Form::email('email', Auth::user()->email, ['placeholder' => 'Email', 'class' => 'cartAddress__inp', 'required' => 'required']) }}
                    </div>
                ...
                <div class="cartAddress__row">
                    ...
                    {{ Form::text('address', Auth::user()->address, ['class' => 'cartAddress__inp', 'placeholder' => 'Адрес']) }}
                ...
                <div class="cartAddress__row">
                    <div><label>{{ Form::radio('delivery', 'Cdek') }} Cdek</label></div>
            ...
            <div class="cartBlock cartPay">
                ...
                <button class="cartPay__btn btn" type="submit">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="26px" height="9px">
