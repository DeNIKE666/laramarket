...
@section('content')
    <div class="lcPageContentData">
        <a href="{{ route('admin.payment_option.create') }}" style=" width: 200px" class="lcPageContentSort__btn btn">Добавить</a>
        <br><br>
                        ...
                        <div class="lcPageContentCol__more">
                            ...
                            <div class="lcPageContentCol__drop">
                                <span>
                                   ...
                                   <a href="{{ route('admin.payment_option.edit', $payment->id) }}">
                                        Редактировать
                                   </a>
                                </span>
                                <span>
