...
@section('content')
    <div class="lcPageAdd">
        ...
        {{ Form::open(['route' => ['seller.products.update', $product], 'files' => true, 'method' => 'put']) }}
        <div class="lcPageAddContent">
            <div class="lcPageAddContentToggle lcPageAddInps">
                ...
                <div class="lcPageAddInp">
                    ...
                    @include('dashboard.seller.product.block.list_categories', ['categories' => $categories, 'active' => $product->category_id])
                </div>
