...
@section('content')
    <div class="lcPageAdd">
        ...
        {{ Form::open(['route' => 'seller.products.store', 'files' => true, 'method' => 'post']) }}
        <div class="lcPageAddContent">
            ...
            <div class="lcPageAddContentToggle lcPageAddInps">
                ...
                <div class="lcPageAddInp">
                    ...
                    @include('dashboard.seller.product.block.list_categories', ['categories' => $categories, 'active' => optional($product)->category_id])
                </div>
            ...
            <div
                    ...
                    data-url="{{ route('seller.product_attributes') }}"
