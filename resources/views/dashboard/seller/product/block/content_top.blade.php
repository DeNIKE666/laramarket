...
<div class="lcPageContentProductsTop">
    <div class="lcPageContentProductsTop__add">
        <a href="{{ route('seller.products.create') }}" style=" width: 150px" class="lcPageContentSort__btn btn">Добавить</a>
    </div>
    ...
    <div class="lcPageContentProductsTop__actions">
        ...
        <button id="js_product_enable"
                ...
                data-route="{{ route('seller.products.change_status_for_checked', 'active') }}"
        >
        ...
        <button id="js_product_disable"
                ...
                data-route="{{ route('seller.products.change_status_for_checked', 'disable') }}"
        >
            <svg width="26px" xmlns="http://www.w3.org/2000/svg"
                 version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                 style="enable-background:new 0 0 512 512;" xml:space="preserve">
        ...
        <button id="js_product_enable_all"
                class="lcPageContentProductsTop__action tooltip"
                title="Включить все"
                data-route="{{ route('seller.products.change_status_for_all', 'active') }}"
        >
            <svg width="26px" xmlns="http://www.w3.org/2000/svg"
                 version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512"
                 style="enable-background:new 0 0 512 512;" xml:space="preserve">
        ...
        <button id="js_product_disable_all"
                class="lcPageContentProductsTop__action tooltip"
                title="Отключить все"
                data-route="{{ route('seller.products.change_status_for_all', 'disable') }}"
        >
            <svg width="26px" xmlns="http://www.w3.org/2000/svg"
        ...
        <button id="js_product_destroy"
                data-route="{{ route('seller.products.destroy_for_checked') }}"
                class="lcPageContentProductsTop__action tooltip"
