<div class="lcPageContentRow">
    ...
    <div class="lcPageContentCol">
        <a href="{{ route('seller.products.edit', $product->id) }}">{{ $product->title }}</a>
    </div>
    <div class="lcPageContentCol">
        {{ $product->getCost() }}
    </div>
            ...
            <div class="lcPageContentCol__drop">
                ...
                <span>
                    <svg width="14px" xmlns="http://www.w3.org/2000/svg"
                        ...
                        {!! Form::open(['route' => ['seller.products.destroy', $product->id], 'method' => 'delete']) !!}
                ...
                <span>
                    ...
                    <a href="{{ route('seller.products.create_from_copy', ['product' => $product->id]) }}">
                        Копировать
                    </a>
                </span>
            </div>
